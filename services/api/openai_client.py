...
class LusterOpenAIClient:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.prompts_dir = Path(__file__).parent.parent.parent / "OpenAI" / "gpt-image-enhancer" / "prompts"
...
• No synthetic lighting effects or halos"""
    ...
    def enhance_image(
        ...
        try:
            ...
            # Build the prompt
            base_prompt = self.style_presets.get(style_preset, self.style_presets["default"])
    ...
    def validate_image_file(self, file_path: str, max_size_mb: int = 10) -> Dict[str, Any]:
        """
